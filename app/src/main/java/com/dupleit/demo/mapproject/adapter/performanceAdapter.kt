...
import kotlinx.android.synthetic.main.card_performance.view.*
import kotlinx.android.synthetic.main.card_subjects.view.*

/**
 * Created by mandeep on 8/11/17.
 */
class performanceAdapter (val userList: ArrayList<Subject>): RecyclerView.Adapter<performanceAdapter.ViewHolder>() {
